<div id="smm-panel-settings" class="smm-panel-settings smm-panel">
	<# if ( data.depth == 1 ) { #>
		...
		<table class="form-table">
			<tr>
				<th scope="row"><?php esc_html_e( 'Hide label', 'penshop' ) ?></th>
				<td>
					<label>
						...
						<?php esc_html_e( 'Hide menu item text', 'penshop' ) ?>
					</label>
				</td>
			</tr>

			<tr>
				<th scope="row"><?php esc_html_e( 'Disable link', 'penshop' ) ?></th>
				<td>
					<label>
						...
						<?php esc_html_e( 'Disable menu item link', 'penshop' ) ?>
					</label>
				</td>
			</tr>
		</table>
