...
<div id="smm-panel-icon" class="smm-panel-icon smm-panel">
	<div class="smm-icon-selector">
		<p>
			<span id="smm-selected-icon" title="<?php esc_html_e( 'Click to remove', 'penshop' ) ?>">
				<# if ( data.megaData.icon ) { #>
					<i class="{{ data.megaData.icon }}"></i>
				<# } #>
			</span>
			<span id="smm-remove-icon"></span>
			<input class="smm-icon-search" type="text" placeholder="<?php esc_attr_e( 'Search Icon', 'penshop' ) ?>">
