...
class PenShop_Popular_Posts_Widget extends WP_Widget {
	/**
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'PenShop - Popular Post', 'penshop' ),
			array(
				'classname'   => 'popular-posts-widget',
				'description' => esc_html__( 'Display most popular posts', 'penshop' ),
			)
		);
	}
			...
			<div class="popular-post post clearfix <?php echo esc_attr( $class ); ?>">
				...
				if ( ! $class ) {
					printf(
						...
						get_the_post_thumbnail( get_the_ID(), 'penshop-widget-thumbnail' )
					);
				}
				?>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'limit' ) ); ?>"><?php esc_html_e( 'Number Of Posts', 'penshop' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_date' ) ); ?>"><?php esc_html_e( 'Show Date', 'penshop' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_thumb' ) ); ?>"><?php esc_html_e( 'Show Thumbnail', 'penshop' ); ?></label>
		</p>
