...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
		<p class="register-link">
			<a href="#" class="toggle-register-form toggle-form"><?php esc_html_e( 'Register new account', 'penshop' ) ?></a>
		</p>
	...
	<div class="u-column2 col-2">
		...
		<p class="login-link">
			<a href="#" class="toggle-login-form toggle-form"><?php esc_html_e( 'Already have an account? Login here!', 'penshop' ) ?></a>
		</p>
